...
class Kv2Joint
{
  public:
	Kv2Joint(){}
	Kv2Joint(const _Joint& kcbPosition, const ofVec2f& kcbScreenPosition, const _JointOrientation& kcbOrientation)
	{
		...
		jointScreenPosition.set(kcbScreenPosition.x/2, kcbScreenPosition.y/2);
...
class ofxKinectCommonBridge : protected ofThread {
  public:
	...
	*/
	...
	pair<JointType, JointType> getSkeletonDrawOrder(int index);
